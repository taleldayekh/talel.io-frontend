...
export default function PaginationController({ count, page, onChange, defaultTruncationBoundary, firstPage, setPaginationRange, render }: PaginationControllerProps) {
    ...
    const isPageOutsideBoundaries = (page: number, count: number, defaultTruncationBoundary: number): boolean => {
        return page >= defaultTruncationBoundary && page <= (count - defaultTruncationBoundary + 2);
    }
    ...
    const onPrevClicked = () => {
        ...
        const pageIsOutsideBoundaries = isPageOutsideBoundaries(prevPage, count, defaultTruncationBoundary);
    ...
    const onNextClicked = () => {
        ...
        const pageIsOutsideBoundaries = isPageOutsideBoundaries(nextPage, count, defaultTruncationBoundary);
