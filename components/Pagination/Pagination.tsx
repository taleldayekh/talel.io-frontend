...
import {
  PaginationProps,
  PaginationRange,
} from 'components/Pagination/interfaces';
      ...
      render={(
        ...
        return (
          <>
            ...
            <button
              className={`${
                page === firstPage && styles['pagination__page-button--active']
              }`}
              onClick={() => onPageClicked(firstPage)}
            >
              {firstPage}
            </button>
              ...
              .map((pageInRange, index) => {
                ...
                return (
                  <button
                    className={`${
                      page === activePage &&
                      styles['pagination__page-button--active']
                    }`}
                    key={index}
                    onClick={() => onPageClicked(activePage)}
                  >
                    {activePage}
                  </button>
                );
            ...
            <button
              className={`${
                page === count && styles['pagination__page-button--active']
              }`}
              onClick={() => onPageClicked(count)}
            >
              {count}
            </button>
